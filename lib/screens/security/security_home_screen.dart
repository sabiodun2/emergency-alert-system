              ...
              Expanded(
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    int currentAlertCount = snapshot.data!.docs.length;
                    
                    if (!isFirstLoad && currentAlertCount > previousAlertCount) {
                      playAlertSound();
                      ...
                      onPressed: () async {
                        bool? confirmDelete = await showDialog<bool>(
                          ...
                          builder: (context) => AlertDialog(
                            ...
                            content: Text('Are you sure you want to permanently delete this resolved alert? This action cannot be undone.'),
                            actions: [
                              TextButton(
